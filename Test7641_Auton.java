...
@Autonomous(name="Basic: Linear OpMode", group="Linear Opmode2")

public class Test7641_Auton extends LinearOpMode {
    ...
    public void colorDetection(double power){
        ...
        while(opModeIsActive()){
            ...
            if(sensed==false && robot.Csensor.alpha()<8){
                robot.frontLeft.setPower(power);
                robot.backLeft.setPower(power);
                robot.frontRight.setPower(power);
                robot.backRight.setPower(power);
    ...
    public void runOpMode() {
        ...
        if(goal.equals("0"))
        {
            ...
            // encoderStrafe(0.3,-2,5);
            attachmentMethod(3);
            //encoderStrafe(0.3,2,5);
            moveWobbleArmUp();
            encoderStrafe(0.3,15,10); //was 15
        ...
        {
            //   encoderDrive(0.25,3,3,5);
            //  encoderStrafe(0.8,-2,5);
            attachmentMethod(3);
            //encoderStrafe(0.8,2,5);
            moveWobbleArmUp();
            encoderDrive(0.9,8,8,5);
            encoderStrafe(0.3,-25,5);
            encoderDrive(0.9,65,65,5);
            sleep(200);
            // encoderStrafe(0.5,-24,5);
            //  attachmentMethod(3);
            encoderStrafe(0.3,21,5);
            //   encoderStrafe(0.3,20,5);
            moveWobbleArmDown();
            moveWobbleArmDown();
            sleep(250);
            robot.wobbleClaw.setPosition(0);
            moveWobbleArmUp();
            //encoderDrive(0.8,1,-1,4);
            robot.intakeMotor.setPower(-1);
            sleep(250);
            colorDetection(-0.3);
         /*   encoderDrive(0.9,-38,-38,10);
            robot.shooterMotor.setPower(1); 
            sleep(2000); 
        ...
        else if(goal.equals("4"))
        {
            ...
            //encoderStrafe(0.3,2,5);
            moveWobbleArmUp();
            encoderStrafe(0.3,12,5);
            encoderDrive(0.8,-1,1,5);
            encoderDrive(0.8,94,94,10);
            moveWobbleArmDown();
            moveWobbleArmDown();
            sleep(250);
            robot.wobbleClaw.setPosition(0);
            moveWobbleArmUp();
            encoderStrafe(0.5,-24,5);
            encoderDrive(0.8,30,-30,10);
            encoderDrive(0.8,15,15,10);
            moveWobbleArmDown();
            
         /*   encoderDrive(-0.5,-85,-85,5); 
            sleep(200);
