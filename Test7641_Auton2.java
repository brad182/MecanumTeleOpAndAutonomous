...
@Autonomous(name="Basic: Linear OpModeComp", group="Linear Opmode2")

public class Test7641_Auton2 extends LinearOpMode {
    ...
    public void colorDetection(double power){
        ...
        while(opModeIsActive()){
            ...
            if(sensed==false && robot.Csensor.alpha()<5){
                robot.frontLeft.setPower(power);
                robot.backLeft.setPower(power);
                robot.frontRight.setPower(power);
                robot.backRight.setPower(power);
    ...
    public void attachmentMethod(int rings){
        ...
        sleep(1500);
        robot.shooterMotor.setPower(1); //was 0.95
        sleep(1500);
        robot.intakeMotor.setPower(-1);
        robot.trayMotor.setPower(1);
        sleep(400);
    ...
    public void runOpMode() {
        ...
        if(goal.equals("0"))
        {
            ...
            attachmentMethod(3);
            moveWobbleArmUp();
            encoderStrafe(0.3,18,10); //was 15
        ...
        else if(goal.equals("1"))
        {
            ...
            // encoderStrafe(0.5,-24,5);
            //  attachmentMethod(3);
            encoderDrive(0.25,18,18,5);
            encoderStrafe(0.3,22,5);
            moveWobbleArmDown();
            moveWobbleArmDown();
            sleep(250);
            robot.wobbleClaw.setPosition(0);
