...
@Autonomous(name="TwoWobbleAuton", group="Linear Opmode2")

public class Test7641_TwoWobbleAuton extends LinearOpMode {
    ...
    public void colorDetection(double power){
        ...
        while(opModeIsActive()){
            ...
            if(sensed==false && robot.Csensor.alpha()<30){
                robot.frontLeft.setPower(power);
                robot.backLeft.setPower(power);
                robot.frontRight.setPower(power);
                robot.backRight.setPower(power);
        ...
        if (tfod != null) {
            ...
            if (updatedRecognitions != null) {
                ...
                for (Recognition recognition : updatedRecognitions) {
                    ...
                    telemetry.update();
                    return "0"; //change back to stackval
                }
            }
        }
        return "0"; //change back to stackval
    ...
    public void runOpMode() {
        ...
        robot.servoMotorOne.setPosition(0.8);
        robot.servoMotorTwo.setPosition(0.1);
        /**
        ...
        sleep(2000);
        moveWobbleArmDown();
        encoderDrive(0.25,12,12,5);
        intakeLock();

        if(goal.equals("0"))
        {
          /*  encoderDrive(0.25,6,6,5);
         robot.shooterMotor.setPower(1);
            sleep(2000);
            robot.intakeMotor.setPower(-1);
            robot.trayMotor.setPower(1);
        ...
        else if(goal.equals("1"))
        {
           /* encoderDrive(0.25,6,6,5);
            ...
            sleep(1000);
            */
            encoderStrafe(0.5,-10,5);
            encoderDrive(0.5,48,48,5);
            sleep(200);
            // encoderStrafe(0.5,-24,5);
            //  attachmentMethod(3);
            encoderDrive(0.25,24,24,5);
            encoderStrafe(0.5,32,5);
            moveWobbleArmDown();
            sleep(250);
            robot.wobbleClaw.setPosition(0);
            moveWobbleArmUp();
            //encoderStrafe(0.8,-15,5);
            encoderDrive(0.8,-64,-64,5);
            encoderDrive(0.8,7.5,-7.5,5);
            moveWobbleArmDown();
            robot.wobbleClaw.setPosition(1);
            moveWobbleArmUp();
        ...
        robot.shooterMotor.setPower(0);
        */
            encoderStrafe(0.3,15,5);
            encoderDrive(0.8,80,80,10);
            moveWobbleArmDown();
            sleep(250);
            robot.wobbleClaw.setPosition(0);
            moveWobbleArmUp();
            encoderStrafe(0.5,-24,5);
            //colorDetection(-0.25);
            encoderDrive(-0.8,-85,-85,5);
            sleep(200);
            encoderStrafe(0.2,-16,5);

            //   attachmentMethod(3);
            //encoderStrafe(0.2,-24,5);
            //colorDetection(0.3);
            encoderDrive(0.5,26,-26,5);
            encoderDrive(0.5,8-8,-8,5);
            moveWobbleArmDown();
            robot.wobbleClaw.setPosition(1);
            moveWobbleArmUp();
            encoderDrive(0.8,32,-32,5);
            encoderDrive(0.8,75,75,5);
            moveWobbleArmDown();
        }
